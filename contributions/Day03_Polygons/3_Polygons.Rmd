...
```{r full-panel, fig.width = 18, fig.height = 12.5}
map_cdv_c + map_cancer_c + map_diabetes_c + map_hiv_c + map_malaria_c + map_conflict_c + plot_layout(ncol = 3)

ggsave(here::here("contributions", "Day03_Polygons", "Polygons_GlobalMortality_Chloropleth.pdf"), 
       width = 18, height = 12.5, device = cairo_pdf)
```
