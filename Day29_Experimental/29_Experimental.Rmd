...
x25 <-
  ...
  ggplot(aes(x_factor, -y)) + 
    ...
    labs(title = "World Population Stripes",
         subtitle = "This map shows the world population along a latitudinal gradient. Each stripe represents the distribution of the human population and covers approx. 1900 km in width at the Equator.",
