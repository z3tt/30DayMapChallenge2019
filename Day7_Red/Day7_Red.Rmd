---
title: "#30DayMapChallenge Day 7: Red - Berlin Tram by OpenStreetMaps"
...
berlin_transport_types %>% 
  ...
  ggplot() +
    ...
    labs(x = NULL, y = NULL,
         title = "Berlin <span style='color:#ba1818'>Tram</span> Stops",
         caption = "Visualization by Cédric Scherer  •  Data by OpenStreetMap & Geoportal Berlin")

ggsave(here::here("Day7_Red", "Day7_Red_Tram.pdf"), width = 9, height = 8.12, device = cairo_pdf)
```
