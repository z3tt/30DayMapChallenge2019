...
ggsave(here::here("Day3_Polygons", "3_Polygons_GlobalMortality.pdf"), width = 18, height = 12.5, device = cairo_pdf)
```
...
ggsave(here::here("Day3_Polygons", "3_Polygons_Alcohol_Drugs.pdf"), width = 11, height = 14, device = cairo_pdf)
```
