---
title: "#30DayMapChallenge Day 8: Green - Berlin S-Bahn by OpenStreetMaps"
...
berlin_transport_types %>% 
  ...
  ggplot() +
    ...
    labs(x = NULL, y = NULL,
         title = "Berlin <span style='color:#038354'>S-Bahn</span> Stops",
         caption = "Visualization by Cédric Scherer  •  Data by OpenStreetMap & Geoportal Berlin")

ggsave(here::here("Day8_Green", "Day8_Green_Railway.pdf"), width = 9, height = 8.12, device = cairo_pdf)
```
